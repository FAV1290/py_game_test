...
DEATH_SCREEN_FILEPATH = 'assets/death_screen.jpg'


#Fonts and texts
INTERFACE_FONT = None
INTERFACE_FONT_SIZE = 48
INTRO_TEXT_FONT = None
INTRO_TEXT_FONT_SIZE = 24
INTRO_TEXT_LIST = [
...
GET_HURT_SOUND_FILEPATH = 'assets/get_hurt_sound.ogg' 
DEATH_SOUND_FILEPATH = 'assets/death_sound.ogg'
